...
export const MostruarioFuncAdmitido = () => {
    ...
    const FuncionariosAdmitidos = funcionario.filter(funcionario => funcionario.statuFucionario === 'Admitido');
    ...
    const updateFuncionario = async (e) => {
        ...
        axios.put('http://localhost:3030/funcionario/' + funcionarioSelecionado.id, data, headers)
            .then((response) => {
    ...
    const demitirFuncionario = async (e) => {
        ...
        axios.put('http://localhost:3030/funcionario/' + funcionarioSelecionado.id, { statuFucionario: 'Demitido' }, headers)
            .then((response) => {
    ...
    return (
        <Div>
            {funcionarioEditar ? (
                <>
                    <button onClick={() => setFuncionarioEditar(null)} className='w-full flex justify-end'><h1 className='bg-red-600 w-auto font-bold p-1 px-3 rounded-full'>Voltar</h1></button>

                    <form onSubmit={updateFuncionario} className=' grid grid-cols-5 gap-x-2 mt-3'>
                        ...
                        <button type='submit' className='col-span-5 mt-4 bg-orange-400 py-2 px-7 rounded-lg border-2 border-orange-500 font-semibold hover:text-white hover:scale-95 duration-500 mb-3'>Salvar</button>
                ...
                <>
                    <nav className='w-full flex flex-row justify-end items-center gap-3'>
                        <button onClick={demitirFuncionario} className='w-full flex justify-end'>
                            <h1 className='bg-red-600 w-auto font-bold p-1 px-3 rounded-full'>Demitir</h1>
                        </button>

                        <button onClick={() => setFuncionarioSelecionado(null)} >
                            <h1 className='bg-orange-600 w-auto font-bold p-1 px-3 rounded-full'>Voltar</h1>
                        </button>

                        <button onClick={() => setFuncionarioEditar(funcionarioSelecionado)} >
                            <h1 className='bg-green-600 w-auto font-bold p-1 px-3 rounded-full'>Editar</h1>
                        </button>
                    </nav>
