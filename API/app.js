...
io.on("connection", (socket) => {
  ...
  socket.on(`fetch salario`, async () => {
    const response = await axios.get(`${ipServer}/salario`);
    const data = response.data.data;

    socket.emit(`salario data`, data);
  });

  socket.on(`fetch abastecimento`, async () => {
    const response = await axios.get(`${ipServer}/abastecimento`);
    const data = response.data.data;

    socket.emit(`abastecimento data`, data);
  });

  socket.on(`fetch manutencao`, async () => {
    const response = await axios.get(`${ipServer}/manutencao`);
    const data = response.data.data;
